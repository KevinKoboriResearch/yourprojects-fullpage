<template>
  <div class="walle-body" @mousemove="coordinates" @click="$store.commit('walle/setShowWallE', false), $q.fullscreen.toggle()">
...
export default {
  ...
  methods: {
    ...
    coordinates (e) {
      ...
      if (e.clientX > walleCoords) {
        ...
        this.flip = false
        TweenMax.set("#righteyeb2", {// eslint-disable-line
          scaleX: 1 + (1 - e.clientX / walleCoords) / 5
        })
        TweenMax.set("#lefteyeb2", {// eslint-disable-line
          scaleX: 1 + (1 - e.clientX / walleCoords) / 5
        })
        TweenMax.set("#walle", {// eslint-disable-line
  ...
  mounted () {
    ...
    tl.to('#lefteye', 0.5, {
      ...
      ease: Sine.easeOut// eslint-disable-line
    }, 'redo')
    tl.to('#righteye', 0.5, {
      rotation: -5,
      repeat: 3,
    ...
    tl.fromTo('#lefteyeball', 0.05, {
      ...
      yoyo: true,
      transformOrigin: '50% 50%',
      ease: Circ.easeOut// eslint-disable-line
    }, 'redo+=4')
...
TweenMax.to('p', 0.5, {// eslint-disable-line
  opacity: 0,
  delay: 2,
  ease: Sine.easeIn// eslint-disable-line
})
</script>
