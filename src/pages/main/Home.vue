        ...
        <template> -->
            <div class="">
                ...
                <div class="fullpage-vertical">
                    <div class="parallax-bg" :style="{height:100*3+'%',transform:parallaxTransform}"></div>
                    <div class="" v-fullpage="opts" ref="fullpage">
                    <div class="page-1 page bg-green">
    ...
    return {
      ...
      opts: {
        ...
        beforeChange (ele, current, next) {
          ...
          that.index = next
          that.parallaxTransform = 'translate3d(0px,' + next * -17 + '%, 0px)'
          console.log(that.parallaxTransform)
        },
...
body {
    ...
    .parallax-bg{
        ...
        background:url(http://img.mp.itc.cn/upload/20170222/d135fafd738c4a8db5bd47fbda92209f_th.jpeg);
    }
