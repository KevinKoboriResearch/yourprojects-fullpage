<template>
  ...
  <!-- tabindex="-1"
    ...
    >
      <!-- style="background-image: linear-gradient(to bottom right, red, yellow);" -->
          ...
          <div class="justify-center">
            ...
            >
              ...
              <div @click="tab = 'about', $store.commit('colors/updateThemeBGColor', '#2E2E2E')" class="col">
                ...
                >
                  <img class="img-logo" :src="$q.dark.isActive ? require('../assets/your-design-trans-light.png') : require('../assets/your-design-trans.png')">
                </q-btn>
              ...
              >
                <div id="web-preview" class="platform-web mat-only">
                  ...
                  <div class="row">
                    ...
                    <div class="col-10">
                      <q-bar dense>
                        <img class="img-mini-logo" :src="$q.dark.isActive ? require('../assets/your-design-trans.png') : require('../assets/your-trans-10.png')">
                        <q-space />
